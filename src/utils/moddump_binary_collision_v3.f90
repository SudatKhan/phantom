...
module moddump
    ...
    real :: mh,     &  ! star mass
            ...
            omega1, &  ! argument of periapsis of planet1
            omega2
   ...
   !
    ...
    tmpx = x01*cos(omega1) - y01*sin(omega1)
    tmpy = x01*sin(omega1) + y01*cos(omega1)
    x01 = tmpx
    y01 = tmpy
 
    tmpx = vx01*cos(omega1) - vy01*sin(omega1)
    tmpy = vx01*sin(omega1) + vy01*cos(omega1)
    vx01 = tmpx
    vy01 = tmpy
    ...
    tmpx = x02*cos(omega2) - y02*sin(omega2)
    tmpy = x02*sin(omega2) + y02*cos(omega2)
    x02 = tmpx
    y02 = tmpy
 
    tmpx = vx02*cos(omega2) - vy02*sin(omega2)
    tmpy = vx02*sin(omega2) + vy02*cos(omega2)
    vx02 = tmpx
    vy02 = tmpy
   ...
   ! -- create black hole as sink particle
    ...
    write(*,'(a,Es12.5,a)') ' argument of periapsis = ',omega1, ' arc'
    ...
    write(*,'(a,Es12.5,a)') ' argument of periapsis = ',omega2, ' arc'
   ...
   subroutine write_setupfile(filename)
    ...
    call write_inopt(omega1, 'omega1', 'argument of periapsis of planet 1',                               iunit)
    ...
    call write_inopt(omega2, 'omega2',  'argument of periapsis of planet 2',                                        iunit)
   ...
   subroutine read_setupfile(filename,ierr)
    ...
    call read_inopt(omega1, 'omega1',    db,min=0.,errcount=nerr)
    ...
    call read_inopt(omega2, 'omega2',    db,min=0.,errcount=nerr)
